...
const Tooltip: React.FC<TooltipProps> = ({ text, style }) => {
  return (
    <div
      style={style}
      className="absolute left-1/2 z-10 mt-1 -translate-x-1/2 transform rounded bg-secondary-font-pink p-1 px-4 text-sm text-white opacity-100 transition-opacity duration-300"
    >
      {text}
